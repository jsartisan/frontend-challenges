...
export function SignInButton() {
  ...
  return (
    <>
      <DialogTrigger isOpen={ui.isLoginModalOpen} onOpenChange={(open) => ui.toggleLoginModal(open)}>
        <Button variant="secondary" onPress={() => ui.toggleLoginModal(true)}>
          Sign In
        </Button>
        <Popover showArrow placement="bottom end" className="w-[350px]">
