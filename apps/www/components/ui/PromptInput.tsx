...
import { HoverCard, HoverCardContent } from "./HoverCard";
import { InputGroup, InputGroupAddon, InputGroupButton, InputGroupTextarea } from "./InputGroup";
  ...
  const inner = (
    <>
      ...
      <form className={cn("w-full", className)} onSubmit={handleSubmit} {...props}>
        <InputGroup className="bg-muted">{children}</InputGroup>
      </form>
    </>
  );
...
export const PromptInputActionMenu = (props: PromptInputActionMenuProps) => <MenuTrigger {...props} />;
...
export type PromptInputModelSelectProps<T extends object = { id: string }> = ComponentProps<typeof Select<T>> & {
  className?: string;
};
...
export const PromptInputHoverCard = ({ closeDelay = 0, delay = 0, ...props }: PromptInputHoverCardProps) => (
  <HoverCard closeDelay={closeDelay} delay={delay} {...props} />
);

export type PromptInputHoverCardContentProps = ComponentProps<typeof HoverCardContent>;

export const PromptInputHoverCardContent = ({ placement = "start", ...props }: PromptInputHoverCardContentProps) => (
