...
describe('insert', () => {
  ...
  test('Example 2: Insert between intervals', () => {
    expect(insert([[1,2],[3,5],[9,10]], [6,7])).toEqual([[1,2],[3,5],[6,7],[9,10]]);
  });
  ...
  test('Exact match with existing interval', () => {
    expect(insert([[1,3],[6,9]], [6,9])).toEqual([[1,3],[6,9]]);
  });

  test('Adjacent intervals', () => {
    expect(insert([[1,2],[3,4]], [2,3])).toEqual([[1,4]]);
  });

  test('No overlap needed', () => {
    expect(insert([[1,2],[4,5],[7,8]], [10,11])).toEqual([[1,2],[4,5],[7,8],[10,11]]);
  });
});
```
